...
exports.getPrDiffComment = getPrDiffComment;
exports.getPrNoDiffComment = getPrNoDiffComment;
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let list = (0, output_1.outputList)(merger);
            let result = (0, output_1.outputDiff)(merger, inputs.showRemovals);
            core.endGroup();
            ...
            if (inputs.postPrComment) {
                ...
                if (differenceFound) {
                    let requestResult = yield (0, comments_1.postComment)(inputs.repoToken, messageId, getPrDiffComment(Array.from(list), result));
...
function getPrDiffComment(list, result) {
    const bullets = list
        .sort()
        .map(n => `- ${n}`)
        .join('\n');
